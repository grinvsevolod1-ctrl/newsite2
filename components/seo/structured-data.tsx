    ...
    "@graph": [
      {
        ...
        description:
          "Профессиональная студия разработки программного обеспечения в Минске, Беларусь. Команда 50+ разработчиков. Создаем сайты, веб-приложения, мобильные приложения, Telegram ботов, AI решения и десктопные приложения под ключ.",
        address: {
          "@type": "PostalAddress",
          addressCountry: "BY",
      ...
      },
      {
        ...
        description:
          "Разработка сайтов, веб-приложений, мобильных приложений, Telegram ботов, AI решений и десктопных приложений под ключ в Беларуси",
        publisher: {
          "@id": "https://www.netnext.site/#organization",
        },
          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                "@type": "Service",
                name: "Разработка сайтов и веб-приложений",
                description:
                  "Создание современных сайтов и веб-приложений на React, Next.js, Node.js. Лендинги, интернет-магазины, корпоративные сайты, SaaS платформы. От 300 BYN.",
                provider: {
                  "@id": "https://www.netnext.site/#organization",
                },
                areaServed: "BY",
