  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Выберите услугу и пакет, примените промокод для получения скидки</CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Расскажите о вашем проекте..." className="min-h-[120px]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <CardContent className="pt-6">
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span>{(calculatedPrice / (1 - promoDiscount / 100)).toFixed(2)} BYN</span>
                    </div>
                    {promoDiscount > 0 && (
                      <div className="flex justify-between text-sm text-green-600">
                        <span>Скидка ({promoDiscount}%):</span>
                        <span>-{(calculatedPrice / (1 - promoDiscount / 100) - calculatedPrice).toFixed(2)} BYN</span>
                      </div>
                    )}
                    <div className="flex justify-between text-lg font-bold pt-2 border-t">
                      <span>Итого:</span>
                      <span>{calculatedPrice.toFixed(2)} BYN</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            {!user && (
              <p className="text-sm text-center text-muted-foreground">
                Необходимо{" "}
                <a href="/auth" className="text-cyan-600 hover:underline">
                  войти в систему
                </a>{" "}
