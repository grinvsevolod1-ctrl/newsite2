  ...
  const faqs = [
    {
      ...
      answer:
        "Стоимость разработки зависит от сложности проекта, функционала и сроков. Простой веб-сайт начинается от 300 BYN, средней сложности - от 800 BYN, сложные корпоративные решения - от 2000 BYN. Используйте наш калькулятор для предварительного расчета стоимости.",
    },
    {
