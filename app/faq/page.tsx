...
export default function FAQPage() {
  const faqs = [
    {
      question: "Сколько стоит разработка сайта или веб-приложения?",
      answer:
        "Стоимость разработки зависит от сложности проекта, функционала и сроков. Простой сайт (лендинг) начинается от 300 BYN, корпоративный сайт - от 800 BYN, интернет-магазин - от 2000 BYN, сложные веб-приложения - от 3000 BYN. Используйте наш калькулятор для предварительного расчета стоимости.",
    },
    {
      question: "Какие сроки разработки проекта?",
      answer:
        "Сроки зависят от объема и сложности проекта. Простой лендинг - 1-2 недели, корпоративный сайт - 2-4 недели, веб-приложение средней сложности - 1-3 месяца, крупный проект - 3-6 месяцев. Мы всегда согласовываем сроки на этапе планирования и придерживаемся дедлайнов.",
    },
    {
