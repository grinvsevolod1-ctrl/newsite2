...
export const metadata: Metadata = {
  title: "FAQ - Часто задаваемые вопросы | NetNext Минск, Беларусь",
  description:
    "Ответы на часто задаваемые вопросы о разработке сайтов, мобильных приложений и ботов в Минске. Сроки, стоимость, процесс работы с NetNext. Разработка в Беларуси: Минск, Гомель, Брест, Гродно.",
  keywords: [
    "FAQ разработка Минск",
    "вопросы о разработке Беларусь",
    "стоимость разработки сайта Минск",
    "сроки разработки приложения",
    "как заказать разработку Беларусь",
    "разработка под ключ Минск",
    "веб-студия FAQ",
    "цены на разработку РБ",
  ],
  openGraph: {
    title: "FAQ - Часто задаваемые вопросы | NetNext Минск",
    description: "Ответы на вопросы о разработке, сроках, стоимости и процессе работы в Беларуси.",
  ...
  alternates: {
    ...
    languages: {
      "ru-BY": "https://www.netnext.site/faq",
      "be-BY": "https://www.netnext.site/faq",
    },
  },
  other: {
    "geo.region": "BY",
...
export default function FAQPage() {
  const faqs = [
    {
      question: "Сколько стоит разработка сайта/веб-приложения?",
      answer:
        "Стоимость разработки зависит от сложности проекта, функционала и сроков. Простой сайт начинается от 300 BYN, сайт/веб-приложение средней сложности - от 3000 BYN, сложные корпоративные решения - от 20000 BYN. Используйте наш калькулятор для предварительного расчета стоимости.",
    },
    {
      question: "Какие сроки разработки проекта?",
      answer:
        "Сроки зависят от объема и сложности проекта. Простой лендинг - 1-2 недели, сайт/веб-приложение средней сложности - 1-3 месяца, крупный проект - 3-6 месяцев. Мы всегда согласовываем сроки на этапе планирования и придерживаемся дедлайнов.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Конечно! В нашем портфолио представлено более 50 успешных проектов различной сложности: сайты/веб-приложения, мобильные приложения, Telegram боты, AI решения. Мы также можем предоставить контакты клиентов для получения отзывов.",
    },
    {
