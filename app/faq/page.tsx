...
export default function FAQPage() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Сроки зависят от объема и сложности проекта. Простой лендинг - 1-2 недели, веб-приложение средней сложности - 1-3 месяца, крупный ��роект - 3-6 месяцев. Мы всегда согласовываем сроки на этапе планирования и придерживаемся дедлайнов.",
    },
    {
