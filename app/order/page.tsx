...
export const metadata: Metadata = {
  ...
  description:
    "Оформите заказ на разработку сайта или веб-приложения с применением скидок и промокодов. Цены от 300 BYN.",
...
export default function OrderPage() {
  return (
    <div className="min-h-screen pt-16 sm:pt-20 md:pt-24 pb-8 sm:pb-12 md:pb-20 px-3 sm:px-4 md:px-6 lg:px-8 bg-gradient-to-b from-background via-cyan-500/5 to-background">
      ...
      <div className="container max-w-7xl relative">
        <div className="text-center mb-6 sm:mb-8 md:mb-12 lg:mb-16 space-y-2 sm:space-y-3 md:space-y-4">
          <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-600 mb-3 sm:mb-4 shadow-lg shadow-cyan-500/20">
            <Sparkles className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 text-white" />
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 bg-clip-text text-transparent px-4">
            Оформление заказа
          </h1>
          <p className="text-muted-foreground text-sm sm:text-base md:text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed px-4">
            ...
            <Card className="border-2 border-cyan-500/20 bg-gradient-to-br from-cyan-500/5 to-blue-500/5">
              <CardContent className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                <div>
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div className="flex gap-2 sm:gap-3">
                      <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-cyan-500/10 flex items-center justify-center">
                        <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-600" />
                      </div>
                      <div>
                        <div className="font-medium text-xs sm:text-sm mb-0.5 sm:mb-1">Быстрая разработка</div>
                        <div className="text-xs text-muted-foreground">Сроки от 7 дней</div>
                      </div>
                    </div>

                    <div className="flex gap-2 sm:gap-3">
                      <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-blue-500/10 flex items-center justify-center">
                        <Headphones className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" />
                      </div>
                      <div>
                        <div className="font-medium text-xs sm:text-sm mb-0.5 sm:mb-1">Поддержка 24/7</div>
                        <div className="text-xs text-muted-foreground">Всегда на связи</div>
                      </div>
                    </div>

                    <div className="flex gap-2 sm:gap-3">
                      <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-purple-500/10 flex items-center justify-center">
                        <Award className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600" />
                      </div>
                      <div>
                        <div className="font-medium text-xs sm:text-sm mb-0.5 sm:mb-1">Гарантия качества</div>
                        <div className="text-xs text-muted-foreground">100% возврат средств</div>
                      </div>
                    </div>

                    <div className="flex gap-2 sm:gap-3">
                      <div className="flex-shrink-0 w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-orange-500/10 flex items-center justify-center">
                        <Zap className="w-4 h-4 sm:w-5 sm:h-5 text-orange-600" />
                      </div>
                      <div>
                        <div className="font-medium text-xs sm:text-sm mb-0.5 sm:mb-1">Современные технологии</div>
                ...
                <div className="pt-3 sm:pt-4 border-t">
                  <div className="text-xs sm:text-sm font-medium mb-2">Активные промокоды:</div>
                  <div className="space-y-2">
                    <div className="text-xs bg-cyan-500/10 text-cyan-700 dark:text-cyan-400 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg font-mono">
                      WELCOME15 - 15% скидка
                    </div>
                    <div className="text-xs bg-blue-500/10 text-blue-700 dark:text-blue-400 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg font-mono">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 lg:gap-6">
          <Card className="border-cyan-500/20 hover:border-cyan-500/40 transition-colors">
            <CardContent className="p-3 sm:p-4 md:p-6 text-center">
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent mb-1 sm:mb-2">
                100%
              </div>
