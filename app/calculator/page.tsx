...
export const metadata: Metadata = {
  ...
  description:
    "Онлайн калькулятор стоимости разработки веб-приложений, мобильных приложений, Telegram ботов, AI решений в Беларуси. Рассчитайте стоимость вашего проекта за 2 минуты. Цены от 500 BYN. Прозрачное ценообразование для бизнеса в Минске.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Рассчитайте стоимость вашего проекта за 2 минуты онлайн. Цены от 500 BYN.",
